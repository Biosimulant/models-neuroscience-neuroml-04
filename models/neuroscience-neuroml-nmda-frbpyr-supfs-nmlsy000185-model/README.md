...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000185)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-nmda-frbpyr-supfs-nmlsy000185-model/model.yaml
```
