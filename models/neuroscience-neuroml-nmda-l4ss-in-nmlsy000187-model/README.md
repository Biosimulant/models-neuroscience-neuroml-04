...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000187)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-nmda-l4ss-in-nmlsy000187-model/model.yaml
```
