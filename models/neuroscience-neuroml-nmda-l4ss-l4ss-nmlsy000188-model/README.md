...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000188)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-nmda-l4ss-l4ss-nmlsy000188-model/model.yaml
```
