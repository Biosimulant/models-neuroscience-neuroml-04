...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000190)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-nmda-l5ib-deeppyr-nmlsy000190-model/model.yaml
```
