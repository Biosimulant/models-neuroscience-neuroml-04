...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000191)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-nmda-l5ib-in-nmlsy000191-model/model.yaml
```
