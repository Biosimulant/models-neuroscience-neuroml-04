...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000193)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-nmda-l5ib-suppyr-nmlsy000193-model/model.yaml
```
