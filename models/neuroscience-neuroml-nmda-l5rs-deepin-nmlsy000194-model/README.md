...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000194)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-nmda-l5rs-deepin-nmlsy000194-model/model.yaml
```
