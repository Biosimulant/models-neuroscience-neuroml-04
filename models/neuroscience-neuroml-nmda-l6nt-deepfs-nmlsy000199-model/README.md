...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000199)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-nmda-l6nt-deepfs-nmlsy000199-model/model.yaml
```
