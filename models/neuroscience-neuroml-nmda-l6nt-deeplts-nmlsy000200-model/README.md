...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000200)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-nmda-l6nt-deeplts-nmlsy000200-model/model.yaml
```
