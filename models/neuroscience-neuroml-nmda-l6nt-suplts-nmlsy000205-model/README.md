...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000205)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-nmda-l6nt-suplts-nmlsy000205-model/model.yaml
```
