...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000207)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-nmda-l6nt-tcr-nmlsy000207-model/model.yaml
```
