...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000208)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-nmda-rspyr-deeplts-nmlsy000208-model/model.yaml
```
