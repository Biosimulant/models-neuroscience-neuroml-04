...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000209)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-nmda-rspyr-supfs-nmlsy000209-model/model.yaml
```
