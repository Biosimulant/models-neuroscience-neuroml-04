...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000210)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-nmda-rspyr-suplts-nmlsy000210-model/model.yaml
```
