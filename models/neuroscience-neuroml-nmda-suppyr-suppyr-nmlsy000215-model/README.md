...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000215)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-nmda-suppyr-suppyr-nmlsy000215-model/model.yaml
```
