...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY001595)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-nmda-synapse-nmlsy001595-model/model.yaml
```
