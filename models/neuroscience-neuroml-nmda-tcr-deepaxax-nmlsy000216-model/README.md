...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000216)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-nmda-tcr-deepaxax-nmlsy000216-model/model.yaml
```
