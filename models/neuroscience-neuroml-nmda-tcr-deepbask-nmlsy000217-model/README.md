...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000217)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-nmda-tcr-deepbask-nmlsy000217-model/model.yaml
```
