...
**Source**: [neuroml_db](https://neuroml-db.org/model_info?model_id=NMLSY000222)
**Standard**: neuroml
**Authors**: neuroml_db
...
models:
  - repo: Biosimulant/models
    alias: model
    manifest_path: models/neuroscience-neuroml-nmda-tcr-supfs-nmlsy000222-model/model.yaml
```
